...
const Course = () => {
  ...
  return (
    <section
      id="course"
      className="bg-white dark:bg-gray-900 w-full px-6 md:px-12 py-16"
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between mb-12">
        <div className="flex-1">
          <h1 className="text-[#0F0F10] dark:text-white text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight mb-4">
            Top Class SkillCraft <br /> Make Your Skill Stand Out
          </h1>
          <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg max-w-3xl">
            Tingkatkan kemampuanmu lewat kursus terbaik dari mentor ahli dan
            jadikan skill-mu keunggulan yang membedakanmu dari yang lain.
          </p>
        </div>
        ...
        {courses.map((course) => (
          ...
          >
            <span
              ...
              ${
                course.levelCourse === "Beginner"
                  ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                  : course.levelCourse === "Intermediate"
